...
// A unified view for playing ANY audio.
struct AudioPlaybackCell: View {
    let title: String
    let subtitle: String
    let data: Data?
    ...
    var body: some View {
        VStack {
            HStack {
                ...
                // --- THIS IS THE FIX ---
                // A new HStack provides better spacing and custom styling for the buttons.
                HStack(spacing: 16) {
                ...
                .buttonStyle(.plain) // Ensures the custom styling is applied correctly.
            }
            .padding(.vertical, 4)
